...
function_deploy $varFilename $tempDest $backup_dest_cpq
fi
...
function_deploy $varFilename $tempDest $backup_dest_classes
else
...
function_deploy $varFilename $tempDest $backup_dest_ui
else
...
function_deploy $varFilename $tempDest $backup_dest_docs
else
...
function_deploy $varFilename $tempDest $backup_dest_ssp
else
...
function_deploy $varFilename $tempDest $backup_dest_xml
else 
...
function_deploy $varFilename $tempDest $backup_dest_workflow
else
...
function_deploy $varFilename $tempDest $backup_dest_xsl
else 
